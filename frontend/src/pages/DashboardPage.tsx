...
function DashboardContent() {
  ...
  const [mergeRequesterInfo, setMergeRequesterInfo] = useState<{
    display_name: string | null;
    email: string | null;
  } | null>(null);
    ...
    try {
      ...
      if (error) {
        ...
        if (
          ...
          setMergeError(
            'This provider is linked to another account. Use "Merge Another Account" to combine accounts.'
          );
        }
      }
    } catch (err) {
  ...
  async function confirmMerge() {
    ...
    try {
      ...
      if (error) {
        ...
        alert(
          "Accounts merged successfully! Please sign in again with any of your linked providers."
        );
        await supabase.auth.signOut();
        navigate("/auth");
        return;
  ...
  const preferredDisplayName =
    preferredAttributes["display_name"]?.attribute_value ||
    profiles[0]?.display_name ||
    "Unnamed Profile";
  const preferredEmail =
    preferredAttributes["primary_email"]?.attribute_value || session?.user?.email;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3">
            <img
              src={preferredAvatar || `${import.meta.env.BASE_URL}nomen.svg`}
              alt="Profile"
              className={`w-10 h-10 rounded-full ${
                preferredAvatar ? "object-cover" : "dark:invert"
              }`}
            />
            <div>
          ...
          {!user?.profile_id ? (
            ...
            >
              ...
              <p className="opacity-60 text-sm">
                Sign in with an OAuth provider to create one.
              </p>
            </div>
          ) : null}
        </div>
            ...
            {showMergeProviders && (
              ...
              >
                <p className="text-sm opacity-70 mb-4">
                  Sign in with your other account. After authentication, you can
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3 rounded border hover:bg-opacity-5 hover:bg-foreground transition-colors disabled:opacity-50"
                ...
                <form onSubmit={startMergeWithEmail} className="space-y-3">
                  ...
                  <button
                    type="submit"
                    disabled={mergeLoading}
                    className="w-full py-2 px-4 rounded text-sm opacity-70 hover:opacity-100 disabled:opacity-50"
                    style={{ border: "1px solid var(--border)" }}
                  >
        ...
        <div className="mb-6">
          ...
          {!user?.profile_id ? (
            ...
            >
              ...
              <p className="opacity-60 text-sm">
                Connect an account to pull profile details.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
                            ...
                            <div className="text-xs opacity-60">
                              ...
                              {option.identity_id && (
                                <span className="ml-1 opacity-50">
                                  ({option.identity_id.substring(0, 8)}...)
                                </span>
                              )}
                            </div>
                          </div>
        ...
        {profiles[0]?.merged_user_ids && profiles[0].merged_user_ids.length > 0 && (
          ...
          >
            ...
            <p className="text-sm opacity-70">
              ...
              {profiles[0].merged_user_ids.length} merged account(s).
            </p>
            <div className="text-xs opacity-50 mt-2">
              IDs:{" "}
              {profiles[0].merged_user_ids
        ...
        {mergeError && (
          <div
            className="mt-4 p-4 rounded bg-red-50 dark:bg-red-900/20"
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          ...
          >
            ...
            <p className="mb-4 opacity-80">
              ...
              If you accept, your account will be absorbed and you will need to
              sign in again.
            </p>
            ...
            <p className="text-sm opacity-60 mb-4">
              After merging, all your linked providers and profile data will be
              moved to the requesting account. Your current account will be
              deleted.
            </p>
